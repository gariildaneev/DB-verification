...
def compare_reports(file1, file2, output_file):
    ...
    if not df1.columns.equals(df2.columns):
        return "Проверьте структуру таблицы: заголовки должны совпадать"
    else:
        # Проверка файлов на дубликаты и кириллицу в KKS
        error_message1 = pre_comparison_check(df1, file1)
        error_message2 = pre_comparison_check(df2, file2)
